      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url('index.html');?>">
            <img class="img-responsive" src="../vendors/images/logo.png" alt="logo">
          </a>                    
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
			...
			<?php
				if(isset($kodeUser)){
			?>
					<li class="scroll"><a href="<?php echo site_url('/fatncurious/profilUser/') ?>">Profil</a></li>
					<li class="scroll"><a href="<?php echo site_url('/fatncurious/LogOut/') ?>">LogOut</a></li>
			<?php
				}
			?>
